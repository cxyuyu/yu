package main.java.elastic_search;

import main.java.cxyu_spider.Spider;
...
//                map=content.remove(0);
//                lianjie lianjie=new lianjie();
//                lianjie.ess(this.index,map,this.client);
//
//            }
//            catch (Exception e){
//                e.printStackTrace();
...
//    }
    ...
    public static void main(String args[]) throws UnknownHostException {
        ...
        Settings settings = Settings.builder().put("cluster.name", "DeepSearch&")
                .put("xpack.security.user", "elastic:654987").build();
        TransportClient client = new PreBuiltXPackTransportClient(settings)
                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("124.127.117.108"), 9300));
